...
public class RestTemplateTestController {
    ...
    // todo:完成execute
//    @PostMapping("/save-dept-execute")
//    public String saveDeptWithExecute(Dept dept) {
//        String url = "http://localhost:8001/dept/add";
//        RequestCallback requestCallback = httpEntityCallback(request, responseType);
//        RequestCallback requestCallback = httpEntityCallback();
//        restTemplate.execute(url, HttpMethod.POST, , String.class);
//        log.info("exchange:{}", exchange);
//        return exchange.getBody();
//    }
}
